...
class Mainwindow(QMainWindow):
    def __init__(self):
        ...
        self.hex_color = {"red" : "#ff0000" , "blue" : "#00007f" , "green" : "#005500" , "white" : "#ffffff" , "pink" : "#fcaf95" , "orange" : "#ffaa00" , "yellow" : "#ffff00" , "sky" : "#00ffff"}
        ...
        self.sky.clicked.connect(lambda: self.set_color("sky"))
